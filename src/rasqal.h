 ...
 */
#define RASQAL_VERSION_STRING "0.9.18"
 ...
 */
#define RASQAL_VERSION_RELEASE 18
 ...
 * @RASQAL_QUERY_VERB_CLEAR: SPARQL 1.1 (draft) clear graph verb.
...
typedef enum {
  ...
  RASQAL_GRAPH_PATTERN_OPERATOR_LAST = RASQAL_GRAPH_PATTERN_OPERATOR_LET
} rasqal_graph_pattern_operator;
