...
int rasqal_algebra_query_prepare_aggregates(rasqal_query* query, rasqal_algebra_node* node);
int rasqal_algebra_query_add_modifiers(rasqal_query* query, rasqal_algebra_node* node);
